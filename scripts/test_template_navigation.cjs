...
(async()=>{
 ...
 try {
  ...
  await page.screenshot({path:'/private/tmp/dasync-dense-slide-desktop.png',fullPage:true});
  await page.setViewportSize({width:390,height:844});
  assert(await page.evaluate(()=>document.documentElement.scrollWidth<=innerWidth));
  await page.screenshot({path:'/private/tmp/dasync-dense-slide-mobile.png',fullPage:true});
